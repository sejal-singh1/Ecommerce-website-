...
app.post(
  "/api/admin/product/new",isAuthenticated,authorizeRoles("admin"),wrapAsync
...
//GET all  product
app.get(
  "/api/products",wrapAsync(async (req, res,next) => {
...
app.get(
  "/api/admin/products",isAuthenticated,wrapAsync(async (req, res,next) => {
...
app.put("/api/review",isAuthenticated, wrapAsync(async(req,res,next)=>{
  ...
  product.ratings = avg / product.reviews.length;
      ...
      app.get("/api/reviews", wrapAsync(async(req,res,next)=>{
  ...
  //delete review
  app.get("/api/reviews",isAuthenticated, wrapAsync(async(req,res,next)=>{
    ...
    let avg=0;
      ...
      await product.findByIdAndUpdate(req.query._productId,{
        reviews,
        ratings,
         numOfReviews},
        {
